...
- Consolidate all pip package installations into the `environment.yaml` file and removing the previous `requirements.txt` file to simplifies dependency management for new users ([:material-source-pull:110](https://github.com/agoenergy/pypsa-spice/pull/117) by @nhlong2701)
